...
import cucumber.testit.exporter.exporter.json.JsonSerializer;
...
import static cucumber.testit.exporter.exporter.json.JsonDeserializer.deserialize;
...
public class CucumberReportLoader {
    ...
    private String createTestRun(TestRun testRun) {
        ...
        String testRunId;
        try {
            Map<String, Object> map = JsonDeserializer.deserialize(EntityUtils.toString(response.getEntity()), new TypeReference<>() {});
    ...
    private Map<String, Autotest> getAutotests() {
        ...
        do {
            ...
            try {
                autotests.addAll(JsonDeserializer.deserialize(EntityUtils.toString(response.getEntity()), new TypeReference<>() {}));
            } catch (IOException e) {
